namespace projN2
{
    partial class frm_list_equip
    {
        ...
        {
            this.tlp_list_equip = new System.Windows.Forms.TableLayoutPanel();
            ...
            this.tlp_list_equip.SuspendLayout();
            this.SuspendLayout();
            // 
            // tlp_list_equip
            // 
            this.tlp_list_equip.ColumnCount = 2;
            this.tlp_list_equip.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 50F));
            this.tlp_list_equip.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 50F));
            this.tlp_list_equip.Controls.Add(this.btn_confirma, 1, 3);
            this.tlp_list_equip.Controls.Add(this.lbl_confirma, 0, 3);
            this.tlp_list_equip.Controls.Add(this.listView1, 0, 0);
            this.tlp_list_equip.Dock = System.Windows.Forms.DockStyle.Fill;
            this.tlp_list_equip.Location = new System.Drawing.Point(0, 0);
            this.tlp_list_equip.Name = "tlp_list_equip";
            this.tlp_list_equip.RowCount = 4;
            this.tlp_list_equip.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 25F));
            this.tlp_list_equip.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 25F));
            this.tlp_list_equip.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 25F));
            this.tlp_list_equip.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Percent, 25F));
            this.tlp_list_equip.Size = new System.Drawing.Size(800, 450);
            this.tlp_list_equip.TabIndex = 0;
            // 
            // btn_confirma
            // 
            ...
            this.columnHeader3,
            this.columnHeader4});
            this.tlp_list_equip.SetColumnSpan(this.listView1, 2);
            ...
            this.tlp_list_equip.SetRowSpan(this.listView1, 3);
            ...
            // columnHeader3
            // 
            this.columnHeader3.Text = "Descrição do Aparelho";
            ...
            this.Controls.Add(this.tlp_list_equip);
            this.Name = "frm_list_equip";
            this.tlp_list_equip.ResumeLayout(false);
            this.tlp_list_equip.PerformLayout();
        ...
        private System.Windows.Forms.TableLayoutPanel tlp_list_equip;
